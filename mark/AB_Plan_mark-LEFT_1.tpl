template _tmp_1032
{
    ...
    row _tmp_1064
    {
        ...
        row _tmp_5248
        {
            ...
            {
                name = "NUMBER_field";
                location = (0.809975720667019, 1.55431223447522e-015);
            ...
            valuefield _tmp_6334
            {
                ...
                location = (7.5678804115107, 1.55431223447522e-015);
            ...
            text _tmp_40002
            {
                name = ")";
                x1 = 5.15179180389357;
                y1 = 0.0161241656387654;
                x2 = 5.15179180389357;
                y2 = 0.0161241656387654;
                string = ")";
                fontname = "Arial";
                fontcolor = 153;
                fonttype = 2;
    ...
    row _tmp_9602
    {
        ...
        row _tmp_24311
        {
            ...
            {
                name = "AB_MARK";
                location = (6.746875, 1.55431223447522e-015);
                formula = "GetValue(\"ASSEMBLY_POS\")";
                datatype = STRING;
                class = "";
                cacheable = TRUE;
